...
export function SourceWindow({
  ...
  const isStageTextOnlyTweet = isStageTweetEmbed && !binding.source_image_url && !binding.source_media_url
  ...
  const isStageBleedEmbed = surface === 'stage' && (descriptor.kind === 'youtube-embed' || descriptor.kind === 'youtube-linkout' || (descriptor.kind === 'tweet-embed' && !isStageTextOnlyTweet))
