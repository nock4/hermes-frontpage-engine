...
describe('source selection policy', () => {
  ...
  it('filters low-value images while accepting direct raster media', () => {
    ...
    expect(isLowValueVisualImage('https://www.youtube.com/img/desktop/yt_1200.png')).toBe(true)
    expect(isLowValueVisualImage('https://uploads.wikiart.org/Content/wiki/img/banner_top.jpg')).toBe(true)
