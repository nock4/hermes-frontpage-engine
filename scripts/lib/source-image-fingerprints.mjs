...
export function isLowFertilitySourceFingerprint(fingerprint = {}) {
  ...
  if (/\/(button-|nav-|header-|footer-|spacer|gutter|sidebar|affiliatebuttons?)|casino|adspace|banner|1x1|pixel\.png|favicon|avatar|placeholder/.test(url)) return true
