...
export function isLowValueVisualImage(imageUrl) {
  ...
  return /\.svg(?:$|[?#])/.test(lower)
    ...
    || lower.includes('/logo')
    || lower.includes('sharing-card')
    || lower.includes('banner')
    || lower.includes('no-rj')
    || lower.includes('wikiart.org/content/wiki/img/')
    || lower.includes('uploads2.wikiart.org/frame_')
    || /(?:^|[/_\-.])order@?2x(?:[/_\-.]|$)/.test(lower)
    || lower.includes('/img/desktop/yt_')
